Shader "Custom/Sprite-Lit-Player"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings CombinedShapeLightVertex(Attributes v)
            {
                ...
                float2 cameraToPosXY = positionWS.xy - GetCameraPositionWS().xy;
                positionWS.xy = cameraToPosXY * _Shift;
